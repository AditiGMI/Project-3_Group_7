...
const cityData = {
  NewYorkCity: {
    url: 'static/nycdata.json',
    prcpKey: 'nyc_prcp',
    tempKey: 'nyc_max_temp',
    color: 'rgba(255, 99, 132, 0.6)',
  },
  Beijing: {
    url: 'static/bjgdata.json',
    prcpKey: 'bjg_prcp',
    tempKey: 'bjg_max_temp',
    color: 'rgba(54, 162, 235, 0.6)',
  },
  London: {
    url: 'static/lnddata.json',
    prcpKey: 'lnd_prcp',
    tempKey: 'lnd_max_temp',
    color: 'rgba(255, 206, 86, 0.6)',
  },
  Tokyo: {
    url: 'static/tkydata.json',
    prcpKey: 'tky_prcp',
    tempKey: 'tky_max_temp',
    color: 'rgba(75, 192, 192, 0.6)',
  },
  MexicoCity: {
    url: 'static/mxcdata.json',
    prcpKey: 'mxc_prcp',
    tempKey: 'mxc_max_temp',
    color: 'rgba(153, 102, 255, 0.6)',
  },
  Zurich: {
    url: 'static/zchdata.json',
    prcpKey: 'zch_prcp',
    tempKey: 'zch_max_temp',
    color: 'rgba(255, 99, 132, 0.6)',
  },
  Honolulu: {
    url: 'static/hnldata.json',
    prcpKey: 'hnl_prcp',
    tempKey: 'hnl_max_temp',
    color: 'rgba(54, 162, 235, 0.6)',
  },
  Reykjavik: {
    url: 'static/ykdata.json',
    prcpKey: 'ryk_prcp',
    tempKey: 'ryk_max_temp',
    color: 'rgba(255, 206, 86, 0.6)',
  },
  Hobart: {
    url: 'static/hbtdata.json',
    prcpKey: 'hbt_prcp',
    tempKey: 'hbt_max_temp',
    color: 'rgba(75, 192, 192, 0.6)',
  },
  Funchal: {
    url: 'static/fcldata.json',
    prcpKey: 'fcl_prcp',
